...
export const newsAPI = {
  ...
  getById: async (id) => {
    const response = await apiClient.get(`/admin/news?id=${id}`);
    return response.data;
  },
  ...
  update: async (id, data) => {
    const response = await apiClient.put(`/admin/news?id=${id}`, data);
    return response.data;
  },
  
  delete: async (id) => {
    const response = await apiClient.delete(`/admin/news?id=${id}`);
    return response.data;
  },
};
